#### Version 2.0.0
  ...
  / ____/___ _(_)___     /_  __/__  _____/ /_     / ___/_________ _____  ____  ___  _____
 / / __/ __ `/ / __ \     / / / _ \/ ___/ __ \    \__ \/ ___/ __ `/ __ \/ __ \/ _ \/ ___/
/ /_/ / /_/ / / / / /    / / /  __/ /__/ / / /   ___/ / /__/ /_/ / / / / / / /  __/ /    
\____/\__,_/_/_/ /_/    /_/  \___/\___/_/ /_/   /____/\___/\__,_/_/ /_/_/ /_/\___/_/    

#### By Ahmed Algain
All in one tool for **Information Gathering** and **Vulnerability Scanning**

# Scans That You Can Perform:
+ Basic Scan
	- Site Title **NEW**
	- IP Address
...
2. For The Bloggers View To Work Properly you have to configure with moz.com's api keys for that follow the following steps:

**How To Configure with moz.com for Bloggers View Scan**
...
# Usage:
- git clone `https://github.com/AhmedAlgain/Gtech_Scanner`
- cd Gtech_Scanner
- php gtech.php
...
`CMS Detector` currently is able to detect the following CMSs (Content Management Systems) in case the website is using some other CMS, Detector will return _could not detect_.
