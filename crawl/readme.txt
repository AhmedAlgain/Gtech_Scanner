This is a Part of Gtech Scanner
...
The first three files are mendetory for the Gtech Scanner scanner. These files have the list of files and directories which the scanner uses for crawling.
